...
/////////////////////////////////// FUNCIONES DE BANNER DE HOTEL //////////////////////////////////////

// FUNCION PARA ACTUALIZAR BANNER DE HOTEL
function UpdateBanner(codbanner, nombrebanner, descbanner, proceso) {
  // aqui asigno cada valor a los campos correspondientes
  $("#savebanner #codbanner").val(codbanner);
  $("#savebanner #nombrebanner").val(nombrebanner);
  $("#savebanner #descbanner").val(descbanner);
  $("#savebanner #proceso").val(proceso);
}

// FUNCION PARA ELIMINAR BANNER DE HOTEL
function EliminarBanner(codbanner, tipo) {
  swal({
      title: "¿Estás seguro?",
          ...
          success: function(response) {
              try {
                  ...
                  if (data.status === 'success') {
                      ...
                      // Recargar la lista de banners u otra acción
                  ...
                  swal("Oops", "Error en la respuesta del servidor.", "error");
              }
          },
          error: function(xhr, status, error) {
              console.error("Error en la solicitud AJAX:", status, error);
              swal("Oops", "Error en la solicitud AJAX.", "error");
          }
      });
  });
}
