...
?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarMensaje('<?php echo encrypt($reg[$i]["codmensaje"]); ?>','<?php echo encrypt("MENSAJES"); ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarUsuario('<?php echo encrypt($reg[$i]["codigo"]); ?>','<?php echo encrypt($reg[$i]["dni"]); ?>','<?php echo encrypt("USUARIOS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarCategoria('<?php echo encrypt($reg[$i]["codcategoria"]); ?>','<?php echo encrypt("CATEGORIAS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarDocumento('<?php echo encrypt($reg[$i]["coddocumento"]); ?>','<?php echo encrypt("DOCUMENTOS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarTipoMoneda('<?php echo encrypt($reg[$i]["codmoneda"]); ?>','<?php echo encrypt("TIPOMONEDA") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarTipoCambio('<?php echo encrypt($reg[$i]["codcambio"]); ?>','<?php echo encrypt("TIPOCAMBIO") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarMedio('<?php echo encrypt($reg[$i]["codmediopago"]); ?>','<?php echo encrypt("MEDIOSPAGOS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarImpuesto('<?php echo encrypt($reg[$i]["codimpuesto"]); ?>','<?php echo encrypt("IMPUESTOS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarPerfil('<?php echo encrypt($reg[$i]["codperfil"]); ?>','<?php echo encrypt("PERFIL") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
        ...
        <?php
        ############################# CARGAR BANNER DE HOTEL ############################
        if (isset($_GET['CargaBanner'])) {
        ?>
            ...
            <div class="table-responsive">
                <table id="default_order" class="table table-striped table-bordered border display">
                    <thead>
                        <tr role="row">
                            <th>N°</th>
                            <th>Nombre de Banner</th>
                            <th>Descripción de Banner</th>
                            <th>Imagen</th>
                            <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody class="BusquedaRapida">
                        ...
                        <?php
                        $reg = $tra->ListarBanners();

                        if ($reg == "") {

                            echo "<div class='alert alert-danger'>";
                            echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                            echo "<center><span class='fa fa-info-circle'></span> NO SE ENCONTRARON BANNER DEL HOTEL ACTUALMENTE </center>";
                            echo "</div>";
                        } else {
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    <td><?php echo $a++; ?></td>
                                    <td><?php echo $reg[$i]['nombrebanner']; ?></td>
                                    <td><?php echo $reg[$i]['descbanner']; ?></td>
                                    <td>
                                        <img src="<?php echo $reg[$i]['imagenbanner']; ?>" alt="Imagen de Banner" width="100">
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-info btn-rounded" data-placement="left" title="Editar" onClick="UpdateBanner('<?php echo $reg[$i]["codbanner"]; ?>','<?php echo $reg[$i]["nombrebanner"]; ?>','<?php echo preg_replace("/\r\n|\r|\n/", '\n', $reg[$i]["descbanner"]); ?>','update')"><i class="fa fa-edit"></i></button>
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarBanner('<?php echo $reg[$i]["codbanner"]; ?>', 'BANNER')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <?php if ($_SESSION['acceso'] == "administrador" || $_SESSION['acceso'] == "secretaria" || $_SESSION['acceso'] == "recepcionista") { ?><td>
                                            ...
                                            <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarTemporada('<?php echo encrypt($reg[$i]["codtemporada"]); ?>','<?php echo encrypt("TEMPORADAS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                        </td><?php } ?>
                                </tr>
                        <?php }
                        } ?>
                ...
                <table id="datatable" class="table display">
                    ...
                    <tbody class="BusquedaRapida">
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    <td>
                                        <ul class="search-listing list-style-none"><a class="border-bottom pt-0">
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarTipo('<?php echo encrypt($reg[$i]["codtipo"]); ?>','<?php echo encrypt("TIPOS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarTarifa('<?php echo encrypt($reg[$i]["codtarifa"]); ?>','<?php echo encrypt("TARIFAS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning btn-rounded" onClick="ReiniciarClave('<?php echo encrypt($reg[$i]["codcliente"]); ?>','<?php echo encrypt($reg[$i]["dnicliente"]); ?>','<?php echo encrypt("REINICIAR") ?>')" title="Reiniciar Clave">
                                            <font color="white"><i class="fa fa-key"></i></font>
                                        </button>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarProveedor('<?php echo encrypt($reg[$i]["codproveedor"]); ?>','<?php echo encrypt("PROVEEDORES") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarInsumo('<?php echo encrypt($reg[$i]["codinsumo"]); ?>','<?php echo encrypt("INSUMOS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarEntradaInsumo('<?php echo encrypt($reg[$i]["codentrada"]); ?>','<?php echo encrypt($reg[$i]["codinsumo"]); ?>','<?php echo encrypt("ENTRADAINSUMOS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarSalidaInsumo('<?php echo encrypt($reg[$i]["codsalida"]); ?>','<?php echo encrypt($reg[$i]["codinsumo"]); ?>','<?php echo encrypt("SALIDAINSUMOS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                    ...
                    <tbody class="BusquedaRapida">
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td class="text-center"><?php echo $reg[$i]['articulos']; ?></td>
                                    <td class="text-center"><?php echo $simbolo . number_format($reg[$i]['totalpagoc'], 2, '.', ','); ?></td>
                                    <td><?php if ($reg[$i]['fechavencecredito'] == '0000-00-00') {
                                            echo "0";
                                            ...
                                            echo Dias_Transcurridos($reg[$i]['fechapagado'], $reg[$i]['fechavencecredito']);
                                        } ?></td>

                                    <td><?php if ($reg[$i]['fechavencecredito'] == '0000-00-00') {
                                            echo "<span class='badge badge-pill badge-info'><i class='fa fa-check'></i> " . $reg[$i]["statuscompra"] . "</span>";
                                        } elseif ($reg[$i]['fechavencecredito'] >= date("Y-m-d") && $reg[$i]['fechapagado'] == "0000-00-00") {
                                            echo "<span class='badge badge-pill badge-success'><i class='fa fa-exclamation-circle'></i> " . $reg[$i]["statuscompra"] . "</span>";
                                        } elseif ($reg[$i]['fechavencecredito'] < date("Y-m-d") && $reg[$i]['fechapagado'] == "0000-00-00") {
                                            echo "<span class='badge badge-pill badge-danger'><i class='fa fa-times'></i> VENCIDA</span>";
                                        } elseif ($reg[$i]['fechavencecredito'] <= date("Y-m-d") && $reg[$i]['fechapagado'] != "0000-00-00") {
                                            echo "<span class='badge badge-pill badge-info'><i class='fa fa-check'></i> " . $reg[$i]["statuscompra"] . "</span>";
                                        } ?></td>
                                    <td>
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-dark btn-rounded" onClick="EliminarCaja('<?php echo encrypt($reg[$i]["codcaja"]); ?>','<?php echo encrypt("CAJAS") ?>')" title="Eliminar"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                </tr>
                        <?php }
                        } ?>
                        ...
                        <tbody class="BusquedaRapida">
                            ...
                            ?>
                                    <tr role="row" class="odd">
                                        ...
                                        <td><?php if ($reg[$i]['fechavencecredito'] == '0000-00-00') {
                                                echo "<span class='badge badge-pill badge-info'><i class='fa fa-check'></i> " . $reg[$i]["statuspago"] . "</span>";
                                            } elseif ($reg[$i]['fechavencecredito'] >= date("Y-m-d") && $reg[$i]['fechapagado'] == "0000-00-00") {
                                                echo "<span class='badge badge-pill badge-success'><i class='fa fa-exclamation-circle'></i> " . $reg[$i]["statuspago"] . "</span>";
                                            } elseif ($reg[$i]['fechavencecredito'] < date("Y-m-d") && $reg[$i]['fechapagado'] == "0000-00-00") {
                                                echo "<span class='badge badge-pill badge-danger'><i class='fa fa-times'></i> VENCIDA</span>";
                                            } elseif ($reg[$i]['fechavencecredito'] <= date("Y-m-d") && $reg[$i]['fechapagado'] != "0000-00-00") {
                                                echo "<span class='badge badge-pill badge-info'><i class='fa fa-check'></i> " . $reg[$i]["statuspago"] . "</span>";
                                        ...
                                        <td><?php if ($reg[$i]['reservacion'] == "PENDIENTE") {
                                                echo "<span class='badge badge-pill badge-danger'><i class='fa fa-exclamation-circle'></i> " . $reg[$i]["reservacion"] . "</span>";
                                            } elseif ($reg[$i]['reservacion'] == "ACTIVA") {
                                                echo "<span class='badge badge-pill badge-success'><i class='fa fa-check'></i> " . $reg[$i]["reservacion"] . "</span>";
                                            } elseif ($reg[$i]['reservacion'] == "CANCELADA") {
                                                echo "<span class='badge badge-pill badge-dark'><i class='fa fa-check'></i> " . $reg[$i]["reservacion"] . "</span>";
                                            } else {
                                                echo "<span class='badge badge-pill badge-info'><i class='fa fa-check'></i> " . $reg[$i]["reservacion"] . "</span>";
                                            } ?></td>
                    ...
                    <tbody class="BusquedaRapida">
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td><?php if ($reg[$i]['fechavencecredito'] == '0000-00-00') {
                                            echo "<span class='badge badge-pill badge-info'><i class='fa fa-check'></i> " . $reg[$i]["statusventa"] . "</span>";
                                        } elseif ($reg[$i]['fechavencecredito'] >= date("Y-m-d") && $reg[$i]['fechapagado'] == "0000-00-00") {
                                            echo "<span class='badge badge-pill badge-success'><i class='fa fa-exclamation-circle'></i> " . $reg[$i]["statusventa"] . "</span>";
                                        } elseif ($reg[$i]['fechavencecredito'] < date("Y-m-d") && $reg[$i]['fechapagado'] == "0000-00-00") {
                                            echo "<span class='badge badge-pill badge-danger'><i class='fa fa-times'></i> VENCIDA</span>";
                                        } elseif ($reg[$i]['fechavencecredito'] <= date("Y-m-d") && $reg[$i]['fechapagado'] != "0000-00-00") {
                                            echo "<span class='badge badge-pill badge-info'><i class='fa fa-check'></i> " . $reg[$i]["statusventa"] . "</span>";
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-info btn-rounded" data-placement="left" title="Abonar" data-original-title="" data-href="#" data-toggle="modal" data-target="#myModalPago" data-backdrop="static" data-keyboard="false" onClick="AbonoCreditoReservacion('<?php echo $reg[$i]["codcliente"]; ?>',
                        ...
                        ?>
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-info btn-rounded" data-placement="left" title="Abonar" data-original-title="" data-href="#" data-toggle="modal" data-target="#myModalPago" data-backdrop="static" data-keyboard="false" onClick="AbonoCreditoVenta('<?php echo $reg[$i]["codcliente"]; ?>',
