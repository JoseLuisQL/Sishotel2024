                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="form-group has-feedback">
                                ...
                                <input type="hidden" name="formulario" id="formulario" value="rooms"/>
                ...
                <tr role="row" class="odd">
                  ...
                  <figure class="more-link">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                      ...
                      <span class="facility-icon">
                        <a href="details?h=<?php echo encrypt($hab[$i]["codhabitacion"]) ?>" title="Leer más" class="tips">...</a>
                      </span>

                    <div class="price"> <span itemprop="priceRange"><h4>PISO: <?php echo $hab[$i]['piso']; ?></h4></span></div>
                    <div class="price"> <span itemprop="priceRange"><h4>VISTA: <?php echo $hab[$i]['vista']; ?></h4></span></div>
                    </div>
                  </div>

                  <div class="col-lg-4 col-md-4 col-sm-4 text-center sep">
                    <div class="price"> <span itemprop="priceRange"><h4>Temporada Baja <?php echo $simbolo.$hab[$i]['baja']; ?></h4></span> </div>
                    <div class="price"> <span itemprop="priceRange"><h4>Temporada Media <?php echo $simbolo.$hab[$i]['media']; ?></h4></span> </div>
                    <div class="price"> <span itemprop="priceRange"><h4>Temporada Alta <?php echo $simbolo.$hab[$i]['alta']; ?></h4></span> </div>
